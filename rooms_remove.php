...
<form action="rooms_remove.php" method="post">
    <h1>In this page you can remove an entry. Just enter the primary key, which can be found when you view the database.</h1>
    Enter the ID, of the content you wish to delete:&nbsp;<input type="text" name="RoomID" required><br><br>
