...
$sql = "SELECT KinID, StudentID, Kin_Name, Kin_RelationShip, Kin_Contact, Kin_EmailAddress, Kin_PermNum, Kin_PermPCode, Kin_Country, AdditionalComments from NextOfKin";
$result = $conn-> query($sql);
    
if ($result-> num_rows > 0){
    while($row = $result-> fetch_assoc()){
        echo "<tr><td>". $row["KinID"] . "</td><td>". 
            $row["StudentID"] . "</td><td>". 
            $row["Kin_Name"] . "</td><td>". 
            $row["Kin_RelationShip"] . "</td><td>". 
            $row["Kin_Contact"] . "</td><td>". 
            $row["Kin_EmailAddress"] . "</td><td>". 
            $row["Kin_PermNum"] . "</td><td>". 
            $row["Kin_PermPCode"] . "</td><td>". 
            $row["Kin_Country"] . "</td><td>". 
