...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO `Undergraduate`(`StudentID`, `CourseID`) VALUES ('$StudentID', '$CourseID')";
...
?>
    ...
    <form action="undergraduate_add.php" method="post">
