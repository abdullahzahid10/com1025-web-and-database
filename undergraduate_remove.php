...
<html>
<head>
<title>Undergraduate - Remove</title>
<style>
.header {
padding: 30px;
text-align: center;
    ...
    
{
    ...
    $query = "DELETE FROM `Undergraduate` WHERE `StudentID` = '$StudentID'";
...
<form action="undergraduate_remove.php" method="post">
    <h1>In this page you can remove an entry. Just enter the primary key, which can be found when you view the database.</h1>
    Enter the ID, of the content you wish to delete:&nbsp;<input type="text" name="StudentID" required><br><br>
