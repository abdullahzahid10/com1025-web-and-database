...
<html>
<head>
<title>Next Of Kin - Remove</title>
<style>
.header {
padding: 30px;
text-align: center;
    ...
    
{
    ...
    $query = "DELETE FROM `NextOfKin` WHERE `KinID` = '$KinID'";
...
<form action="nextofkin.php" method="post">
    ...
    Enter the ID, of the content you wish to delete:&nbsp;<input type="text" name="KinID" required><br><br>
