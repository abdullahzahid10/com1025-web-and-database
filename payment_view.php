...
$sql = "SELECT PaymentID, StudentID, DurationPaidFor, DateOfPayment, ReceiptEmail from Payment";
...
if ($result-> num_rows > 0){
    while($row = $result-> fetch_assoc()){
        echo "<tr><td>". 
            $row["PaymentID"] . "</td><td>". 
            $row["StudentID"] . "</td><td>". 
            $row["DurationPaidFor"] . "</td><td>". 
            $row["DateOfPayment"] . "</td><td>". 
            $row["ReceiptEmail"] . "</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 result";
