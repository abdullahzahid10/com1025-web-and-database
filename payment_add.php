...
if(isset($_POST['insert']))
{
    ...
    $DurationPaidFor = $_POST['DurationPaidFor'];
    $DateOfPayment = $_POST['DateOfPayment'];
    $ReceiptEmail = $_POST['ReceiptEmail'];

    
    $connect = mysqli_connect($hostname,$username ,$password ,$databaseName);
    $query = "INSERT INTO `Payment`(`PaymentID`, `StudentID`, `DurationPaidFor`, `DateOfPayment`, `ReceiptEmail`) VALUES ('$PaymentID', '$StudentID', '$DurationPaidFor', '$DateOfPayment', '$ReceiptEmail')";
...
?>
    ...
    <form action="payment_add.php" method="post">
        <input type="text" name="PaymentID" required placeholder="PaymentID"><br><br>
        <input type="text" name="StudentID" required placeholder="StudentID"><br><br>
        <input type="text" name="DurationPaidFor" required placeholder="DurationPaidFor"><br><br>
        <input type="text" name="DateOfPayment" required placeholder="DateOfPayment"><br><br>
        <input type="text" name="ReceiptEmail" required placeholder="ReceiptEmail"><br><br>
