...
$sql = "SELECT StaffID, Staff_Position, Staff_Name, Staff_Contact, Staff_EmailAddress, Staff_PermNum, Staff_PermPCode, Staff_Gender, Staff_Nationality, Staff_MonthWage, Staff_ContractedHrs, Staff_CardName, Staff_AccountNum, Staff_ExpDate, Staff_SortCode, AdditionalComments from Staff";
...
if ($result-> num_rows > 0){
    while($row = $result-> fetch_assoc()){
        echo "<tr><td>". 
            $row["StaffID"] . "</td><td>". 
            $row["Staff_Position"] . "</td><td>". 
            $row["Staff_Name"] . "</td><td>". 
            $row["Staff_Contact"] . "</td><td>". 
            $row["Staff_EmailAddress"] . "</td><td>". 
            $row["Staff_PermNum"] . "</td><td>". 
            $row["Staff_PermPCode"] . "</td><td>". 
            $row["Staff_Gender"] . "</td><td>". 
            $row["Staff_Nationality"] . "</td><td>". 
            $row["Staff_MonthWage"] . "</td><td>". 
            $row["Staff_ContractedHrs"] . "</td><td>". 
            $row["Staff_CardName"] . "</td><td>". 
            $row["Staff_AccountNum"] . "</td><td>". 
            $row["Staff_ExpDate"] . "</td><td>". 
            $row["Staff_SortCode"] . "</td><td>". 
            $row["AdditionalComments"] . "</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 result";
