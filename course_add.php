...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO `Course`(`CourseID`, `CourseCode`, `CourseName`, `CourseLeader`) VALUES ('$CourseID', '$CourseCode', '$CourseName', '$CourseLeader')";
...
?>
<strong>Please ensure, when entering the CourseID, it is not an existing primary key, or else the data will not pass through</strong>
    <form action="course_add.php" method="post">
        <input type="text" name="CourseID" required placeholder="CourseID"><br><br>
        <input type="text" name="CourseCode" required placeholder="CourseCode"><br><br>
        <input type="text" name="CourseName" required placeholder="CourseName"><br><br>
        <input type="text" name="CourseLeader" required placeholder="CourseLeader"><br><br>
